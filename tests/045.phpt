...
echo "\nGiven callback that returns string too big:\n";
function testC($vol) { return str_repeat("a",2000); }
$rar = RarArchive::open($fn, null, 'testC');
$rar->getEntries();
...
Warning: RarArchive::getEntries(): Cound not expand filename  in %s on line %d
