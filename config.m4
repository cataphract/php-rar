...
if test "$PHP_RAR" != "no"; then
  ...
  PHP_NEW_EXTENSION(rar, rar.c rar_error.c rararch.c rarentry.c rar_stream.c rar_navigation.c rar_time.c $unrar_sources, $ext_shared,,-DZEND_ENABLE_STATIC_TSRMLS_CACHE=1 -DRARDLL -DSILENT -Wno-write-strings -Wno-logical-op-parentheses -Wall -I@ext_srcdir@/unrar)
